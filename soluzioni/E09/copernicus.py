...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Plot and fit noise data.',
                                     usage      ='python3 copernicus.py  --option')
    parser.add_argument('--plotall',   action='store_true',    help='Plot input data for all pollutants')
    parser.add_argument('--co',        action='store_true',    help='FFT analysis for CO')
    parser.add_argument('--pm10',      action='store_true',    help='FFT analysis for PM10')
    parser.add_argument('--nh3',       action='store_true',    help='FFT analysis for NH3')
    
    parser.add_argument('--compare',   action='store_true',    help='Compare FFT analysis results for different pollutants')
...
#####################################################################
#      Funzione principale per analisi inquinanti                   #
#####################################################################
...
def copernicus():
    ...
    #---------------------------------------------------------------#
    # Variabili per confronto finale usate per più opzioni          #
    #---------------------------------------------------------------#

    # CO
    coft     = None      # Coefficienti FT 
    cops     = None      # Spettro di potenza
    cofreq   = None      # Frequenze
    coam     = None      # Massimo Spettro di Potenza
    ...
    if args.co == True or args.compare == True:
        ...
        print('Massimo PS CO: {:f} - Freq {:f} - Periodo: {:d}'.format( cops[coam], cofreq[coam], int(1/cofreq[coam])) )
    ...
    if args.pm10 == True or args.compare == True:
        ...
        print('Massimo PS PM10: {:f} - Freq {:f} - Periodo: {:d}'.format( pm10ps[pm10am], pm10freq[pm10am], int(1/pm10freq[pm10am])) )
    ...
    if args.nh3 == True or args.compare == True:
        ...
        print('Massimo PS NH3: {:f} - Freq {:f} - Periodo: {:d}'.format( nh3ps[nh3am], nh3freq[nh3am], int(1/nh3freq[nh3am])) )
